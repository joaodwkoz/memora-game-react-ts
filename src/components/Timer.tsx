...
export function Timer({ startTime = 0, endTime, hasOvertime, isRunning = true, onTimeEnd, onOvertimeStart }: TimerProps) {
    ...
    useEffect(() => {
        if (endTime !== -1 && seconds >= endTime && !hasFinishedRef.current) {
            ...
            if (isRunning && hasOvertime) {
                ...
                if (timePercentage > 50 && !gameInOvertime) {
        ...
        <div className="flex gap-3 items-center">
            <div className="relative h-8 flex overflow-hidden justify-center w-8">
                ...
                >
                    ...
                    <TooltipRoot>
                        ...
                        <TooltipContent>
                            Essa partida entrou no modo morte súbita. Os parâmetros agora sofrem com um efeito de 2x.
                        </TooltipContent>
                    </TooltipRoot>
                </motion.div>
            </div>
            ...
            {endTime !== -1 ? (
                ...
                <TooltipRoot>
                    ...
                    <TooltipContent>
                        Não há limite para este parâmetro.
                    </TooltipContent>
                </TooltipRoot>
            )}
        </div>
